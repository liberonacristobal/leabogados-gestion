...
- 2026-06-27 — Ficha del cliente: tabs con estilo icono+texto; pestañas renombradas a Resumen · Contacto · **Ventas** · **Cartola** (Ventas = lo comercial, Cartola = el banco); "Exposición tributaria" pasa a icono-sección colapsada con icono de alarma. Landing de Clientes (admin) → directorio A-Z (encabezados de letra + índice lateral + avatar empresa/persona por responsable, sin cifras). Pestaña **Ventas** reorganizada en icono-secciones colapsadas: "Proyectos" (Vigentes + **Terminados**) + "Facturas" (cockpit completo dentro) + Anticipos. **Cartola** = solo banco (Fondos + Movimientos + Anticipos); se quitó la sección Facturas duplicada (vive en Ventas). Pendiente: replicar el directorio A-Z en la vista limited.
